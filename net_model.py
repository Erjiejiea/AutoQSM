...
def vnet(input_shape=[64, 64, 16], output_shape=[32, 32, 8], n=1):
    ...
    layer_up5 = concatenate(
        [Conv3DTranspose(16 * 2, (2, 2, 2), strides=(2, 2, 2), padding='same')(layer_conv4), layer_conv1], axis=4)
    ...
    layer_up6 = concatenate(
        [Conv3DTranspose(16, (2, 2, 2), strides=(2, 2, 2), padding='same')(layer_conv5), layer_conv0], axis=4)
